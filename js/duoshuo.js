    ...
    !e.DUOSHUO) {
        ...
        G.prototype.getJSON = function(e) {
            ...
            return s
                       ...
                       /* return 'https://qqdie.com/duoshuo/ds.php?s='+e.avatar_url || 'https://qqdie.com/duoshuo/ds.php?s='+nt.data.default_avatar_url */
...
if(avatar_url.indexOf("qzapp.qlogo.cn") != -1 || avatar_url.indexOf("wx.qlogo.cn") != -1 ){
 return "//qqdie.com/duoshuo/ds.php?s=" + avatar_url.replace("", "")
}
else
                         if (avatar_url.indexOf("app.qlogo.cn") != -1 || avatar_url.indexOf("q.qlogo.cn") != -1  || avatar_url.indexOf("avatar.duoshuo.com") != -1) {
...
t += "</div>", 1 == i.max_depth && i.show_context && s.parents.length) {
    ...
    "#[生气]":"生气","#[惊讶]":"惊讶","#[喷]":"喷","#[爱心]":"爱心","#[碎心]":"碎心","#[玫瑰]":"玫瑰","#[礼物]":"礼物","#[彩虹]":"彩虹","#[星星月亮]":"星星月亮","#[太阳]":"太阳",
